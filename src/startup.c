...
void exti21_rtc_wakeup_handler(void) __attribute__((weak, alias("default_handler")));
...
uint32_t isr_vector[ISR_VECTOR_SIZE_WORDS] __attribute__((section(".isr_vector"))) = {
  ...
  (uint32_t)&exti21_rtc_wakeup_handler,
...
void reset_handler(void) {
  ...
  uint8_t *flash_data = (uint8_t*) &_edata;
...
/*
gdb-multiarch ./wifi_bootloader -ex 'target extended-remote localhost:3333'
  */